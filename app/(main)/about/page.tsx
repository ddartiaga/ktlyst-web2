...
export default function Page() {
    return (
        <>
            <div className="main-content app-content mt-20">
                <div className="container-fluid">
                    {/* Page Header */}
                    <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb mt-30">
                        <h1 className="page-title fw-semibold fs-18 mb-0">About Us</h1>
                        ...
                        <div className="col-xl-12">
                            <div className="about-container mb-4">
                                                    ...
                                                    <div className="col-xxl-9 col-xl-9 col-lg-10 col-md-8 col-sm-10 col-12">
                                                        <div className="p-3 text-start mb-4">
                                                            ...
                                                            <p className="mb-4 fw-normal op-7 fs-16">
                                                                ...
                                                                It’s admirable, but mistaken. When their enemies were at
                                                                the gates the Romans would suspend democracy and appoint
                                                                one man to protect the city...
                                                            </p>
                                            ...
                                            <div className="col-xl-12 about-company-stats">
                                                <div className="row justify-content-center">
                                                    <div className="col-xxl-5 col-xl-8 col-lg-10 col-md-8 col-sm-10 col-10">
                                                        <div className="card custom-card text-default shadow border">
                                                                        ...
                                                                        <div className="text-center p-4 w-100 h-100 d-flex align-items-center justify-content-center">
                                                                            <div>
                                                                                ...
                                                                                <p className="text-dark fs-2 mb-0">
                                                                                    <span className="count-up" data-count={137}>
                                                                                        137
                                                                                    </span>
                                                                                    +
                                                                                </p>
                                                                    ...
                                                                    <div className="col-xl-4 col-xxl-4 col-lg-4 col-md-4 col-sm-4 about-company-stats-border">
                                                                        <div className="text-center p-4 w-100 h-100 d-flex align-items-center justify-content-center">
                                                                            <div>
                                                                                ...
                                                                                <p className="text-dark fs-2 mb-0">
                                                                                    <span className="count-up" data-count={2500}>
                                                                                        2500
                                                                                    </span>
                                                                                    +
                                                                                </p>
                                                                    ...
                                                                    <div className="col-xl-4 col-xxl-4 col-lg-4 col-md-4 col-sm-4">
                                                                        <div className="text-center p-4 w-100 h-100 d-flex align-items-center justify-content-center">
                                                                            <div>
                                                                                ...
                                                                                <p className="text-dark fs-2 mb-0">
                                                                                    <span className="count-up" data-count={22}>
                                                                                        22
                                                                                    </span>
                                                                                </p>
                                                                            </div>
                                ...
                                <div className="row pb-5 px-3 about-motto">
                                    <div className="col-xxl-5 col-xl-8 col-lg-10 col-md-10 col-sm-12">
