                                                    ...
                                                    <div className="col-xxl-9 col-xl-9 col-lg-10 col-md-8 col-sm-10 col-12">
                                                        <div className="p-3 text-start mb-4">
                                                            ...
                                                            <p className="mb-4 fw-normal op-7 fs-16">
                                                                ...
                                                                back. It’s admirable, but mistaken. When their enemies
                                                                were at the gates the Romans would suspend democracy
                                            ...
                                            <div>
                                                ...
                                                <div className="d-flex mb-4">
                                                    ...
                                                    <div className="ms-4">
                                                        ...
                                                        <p className="text-muted">
                                                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                                            Adipisci quos sint, officia vel ab perferendis illum
                                                            ullam ratione blanditiis fugiat omnis beatae odio vitae!
                                                        </p>
                                                    </div>
                                                </div>
